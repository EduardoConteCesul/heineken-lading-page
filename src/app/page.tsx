...
import { Box, Button, Carousel, Image as ChakraImage, Link as ChakraLink, HStack, Icon, Image, Text, VStack } from "@chakra-ui/react";
...
export default function Home() {
	...
	const itemsCarroselDois: ListItems[] = [
		{ index: 1, img: "assets/homeprodutos.jpg", title: "🍺 22 marcas de cerveja & 6 bebidas não alcoólicas", description: "Com a qualidade HEINEKEN de sempre", linkSaibaMais: "" },
		{ index: 2, img: "assets/cervejaria4.jpg", title: "🏭 15 cervejarias", description: "Onde produzimos as melhores marcas.", linkSaibaMais: "" },
		{ index: 3, img: "assets/nossa-jornada.jpg", title: "🫂\n+13 mil colaboradores", description: "Que transformam a nossa estrela com seu brilho", linkSaibaMais: "" }
	]

	return (
		<VStack as="main" minH="100vh" gap={0} >
			<VStack gap={0} position="relative" mt="5.70rem">
				<Box w="100%">
					<Carousel.Root
						autoplay={{ delay: 2000 }}
